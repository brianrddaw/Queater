    ...
    <div class="flex flex-col gap-4 w-full">
        <div class="flex justify-between gap-4">
            <div class="flex items-center justify-center overflow-hidden w-14 h-14 bg-slate-950 rounded-full drop-shadow-[0_4px_3px_rgba(0,0,0,.3)]">
                <img  class="object-cover w-12 h-12 rounded-full" src="<?php echo e("/storage/" . $product->image_url); ?>" alt="<?php echo e($product->name); ?>">
            </div>
            ...
            <div class="flex flex-col gap-2 max-w-[180px] min-w-[180px]">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <p class="h-fit leading-none"><?php echo e($product->price); ?> €</p>
                </div>
            </div>

            <div class="price-add-container flex flex-wrap justify-center items-center w-fit gap-3">
                <button onclick="addToOrder(<?php echo e($product->id); ?>,<?php echo e($product->price); ?>,'<?php echo e($product->name); ?>','<?php echo e($product->image_url); ?>')" class="add-to-order-button flex items-center text-md text-orange-50 bg-orange-500 w-fit p-1 rounded-full">
        ...
        <div class="product-card-info flex flex-wrap gap-2 bg-slate-100 p-2 rounded-sm mb-0">
            ...
            <div class="flex flex-wrap gap-2 text-sm">
                <?php $__currentLoopData = $product->allergens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allergen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <img  class="allergen cursor-pointer object-cover w-6 h-6 rounded-full"  src="<?php echo e("/storage/" . $allergen->img_url); ?>" alt="<?php echo e($allergen->name); ?>">
...
<?php /**PATH C:\Users\Programación\Desktop\QUEATER\resources\views\user-views\user-product\product-card.blade.php ENDPATH**/ ?>