<div id="cart" class="user-cart hidden grid-rows-10 fixed bottom-0 w-full h-[67vh] bg-stone-100 text-orange-950 py-4 pt-4" >
    ...
    <form id="checkout-form" action="/checkout" method="POST" class="flex justify-center w-full h-full row-span-2 pt-2">
        <input class="hidden" type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
...
<?php /**PATH C:\Users\Programación\Desktop\QUEATER\resources\views\user-views\user-cart\user-cart.blade.php ENDPATH**/ ?>