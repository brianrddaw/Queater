<form action="<?php echo e(route('login')); ?>" method="post" class=" bg-gray-50 max-w-[350px] max-h-[400px] h-[400px] flex flex-col  gap-4 text-orange-950 m-auto mt-16 drop-shadow-lg rounded-lg">
        <?php echo csrf_field(); ?>

        <h1 class="text-center font-bold text-orange-50  text-3xl bg-orange-500 p-4 rounded-t-lg"><?php echo e($title); ?></h1>
