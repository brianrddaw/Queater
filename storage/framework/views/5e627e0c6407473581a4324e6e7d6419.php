    ...
    <main class="w-full h-full min-h-[calc(100vh-3.5rem)] p-4  flex flex-col gap-6">
                ...
                <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="qrCard flex flex-col items-center justify-between w-36 h-fit rounded-lg py-2 bg-stone-200 shadow-4">
                        <div class="bg-orange-950 p-3 rounded">
                            ...
                            <p class="font-bold my-2">MESA: <?php echo e($table->number); ?></p>
                        <div class="flex flex-col gap-2 font-bold">
                            ...
                            <a href="<?php echo e(url('/download-qr-code/'.$table->number)); ?>" class="p-2 bg-red-500 w-32 rounded text-red-800">Descargar QR</a>
                            <button type="button" onclick="deleteTable(<?php echo e($table->number); ?>)" class="btn btn-primary">Eliminar</button>
                        </div>
                    </div>
        ...
        <?php if(file_exists(public_path('storage/qrcodes_images/take_away.svg'))): ?>
            <div class="flex flex-col items-center">
                ...
                <a href="<?php echo e(url('/download-qr-code/take-away')); ?>" class="btn btn-primary">Descargar SVG</a>
