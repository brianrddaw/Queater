...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('user-views.components.slide-bar-component', ['categories' => $productsByCategory], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <main class="eat-here-main flex flex-col items-center bg-stone-100 py-10 pb-20">
            <?php $__currentLoopData = $productsByCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="flex flex-col w-full h-full bg-stone-100 pb-10">
                    <span id="<?php echo e($category); ?>"></span>
                        ...
                        <li class="flex flex-wrap  w-[90%]  rounded mx-auto justify-between gap-4">
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($product->availability): ?>
                                    <?php echo $__env->make('user-views.user-product.product-card', ['product' => $product], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php endif; ?>
            ...
            <?php echo $__env->make('user-views.user-cart.user-cart', ['orders' => []], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </main>
        ...
        <script>
            ...
            function setOrderTotalAndSubmitForm()
            {
                ...
                document.getElementById("take-away-input").value = <?php echo e($takeAway); ?>;
                document.getElementById("table-id-input").value = <?php echo e($tableId); ?>;
...
<?php echo $__env->make('layouts.html-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Programación\Desktop\QUEATER\resources\views\user-views\menu.blade.php ENDPATH**/ ?>