    ...
    <section class="flex flex-col items-center gap-6 mt-6 text-orange-950">
        ...
        <span class="flex flex-col w-fit h-full items-center gap-4 mt-6">
            <div class="min-w-fit w-44 h-14 text-center  flex items-center justify-center gap-1 bg-orange-500 rounded font-bold text-orange-50">
                <a  href="/printTicket/<?php echo e($orderId); ?>/<?php echo e($tableId); ?>">
                    Descargar ticket
                </a>
...
<?php echo $__env->make('layouts.html-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u272775609/domains/queater.com/resources/views/user-views/user-payments/success.blade.php ENDPATH**/ ?>