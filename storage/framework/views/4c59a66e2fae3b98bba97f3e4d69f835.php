            ...
            <div class="card flex flex-col w-[250px]  bg-stone-200 rounded shadow-lg ">
                ...
                <div class="card grid grid-cols-3 w-full rounded">
                    <div class="flex justify-center items-center font-bold text-green-600 col-span-2 p-4 gap-2">
                        <button onclick="showEditCategory(<?php echo e($category->id); ?>, '<?php echo e($category->name); ?>', '<?php echo e($category->description); ?>', <?php echo e($category->position); ?>)">Editar</button>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                        </svg>
                    </div>

                    <button class="flex justify-center bg-walter-400 p-4 w-full  font-bold text-red-600" onclick="showDeleteCategory(<?php echo e($category->id); ?>)">
...
<?php echo $__env->make('dashboard-views.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Programación\Desktop\QUEATER\resources\views/dashboard-views/dashboard-categories.blade.php ENDPATH**/ ?>