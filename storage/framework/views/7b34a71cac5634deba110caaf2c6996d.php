...
<div class="flex flex-col w-full h-full gap-6">
    ...
    <div class="flex  flex-wrap w-[100%] h-[calc(100vh-7.25rem)] gap-4 overflow-y-scroll px-6">
        <?php $__currentLoopData = $productsByCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <h2 class="text-2xl my-6 font-bold bg-orange-500 w-full text-center py-4 rounded-lg text-orange-50"><?php echo e($category); ?></h2>
                ...
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card flex flex-col w-[28rem]  max-h[00px] bg-walter-300 border rounded p-2 py-6 gap-6 text-orange-950 sm:mx-auto lg:mx-0">
                                ...
                                <div class="flex w-full justify-between">
                                    <div class="flex gap-10">
                                        <div class="flex items-center justify-center w-20 h-20 bg-orange-950 rounded-full drop-shadow-[0_4px_3px_rgba(0,0,0,.3)]">
                                            <img  class="object-cover w-16 h-16 rounded-full" src="<?php echo e("/storage/" . $product->image_url); ?>" alt="<?php echo e($product->name); ?>">
                                        </div>
                                    ...
                                    <span class="w-28 flex flex-col gap-2 justify-between items-start">
                                        ...
                                        <p class="font-bold"><?php echo e($product->category->name); ?></p>
                            ...
                            <div class="flex flex-col bg-walter-400 p-2 gap-2 rounded">
                                ...
                                <span class="flex gap-4">
                                    <?php $__currentLoopData = $product->allergens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allergen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <img class="m-w-6 h-6" src="<?php echo e("/storage/" . $allergen->img_url); ?>" alt="<?php echo e($allergen->name); ?>">
                            ...
                            <div class="ml-auto flex gap-2">
                                <button class="font-bold text-green-800 p-2 bg-green-400 min-w-fit w-20 rounded" onclick="showEditProduct(<?php echo e($product); ?>)">Editar</button>
                                <button class="font-bold text-red-900 p-2 bg-red-400 min-w-fit w-20 rounded"  onclick="showDeleteProduct(<?php echo e($product->id); ?>)">Eliminar</button>
                            </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<script>
    function showAddProductForm() {
        Swal.fire({
            ...
            html: `
                <form action="<?php echo e(route('dashboard.products.create')); ?>" enctype="multipart/form-data" action="" id="form-new-products" method="post" class="w-full  h-fit mx-auto  rounded-lg  text-orange-950">
                    <?php echo csrf_field(); ?>
                    <div class="flex flex-col h-full gap-10">
                                ...
                                <div class="flex items-center w-full pr-2">
                                    <select name="category" id="category" class="w-full   bg-transparent  no-underline outline-none border-b-2 border-orange-950 pb-2 mt-2">
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option class="appearance-none w-full border-none bg-transparent" value="<?php echo e($category->id); ?>"><?php echo e($category->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class=" allergens-container flex flex-wrap gap-2 w-full h-fit">
                            <?php $__currentLoopData = $allergens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allergen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <img id="allergen<?php echo e($allergen->id); ?>" class="allergen  cursor-pointer object-cover w-12 h-12 rounded-full grayscale" src="<?php echo e("/storage/" . $allergen->img_url); ?>" alt="<?php echo e($allergen->name); ?>" onclick="addAllergen(<?php echo e($allergen->id); ?>)">
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
    ...
    function createNewProduct(){
        ...
        $.ajax({
            url: '<?php echo e(route('dashboard.products.create')); ?>',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    function showEditProduct(product) {
        ...
        Swal.fire({
            ...
            html: `
                <form action="<?php echo e(route('dashboard.products.update')); ?>" enctype="multipart/form-data" action="" id="form-new-products" method="post" class="w-full h-fit mx-auto  rounded-lg  text-orange-950">
                <form action="<?php echo e(route('dashboard.products.update')); ?>" enctype="multipart/form-data" action="" id="form-new-products" method="post" class="w-full h-fit mx-auto  rounded-lg  text-orange-950">
                    ...
                    <div class="flex flex-col h-full gap-4">
                        ...
                        <div class=" allergens-container flex flex-wrap gap-2 w-full h-fit">
                            ...
                            `+
                                function(){
                                    let allergens = <?php echo json_encode($allergens, 15, 512) ?>;
                                    let allergens_html = '';
    ...
    function editProduct(id) {
        ...
        formData.append('allergens', JSON.stringify(allergens));
        $.ajax({
            url: '<?php echo e(route('dashboard.products.update')); ?>',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    function showDeleteProduct(product_id){
        Swal.fire({
            ...
            html: `
                <form action="<?php echo e(route('dashboard.products.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard-views.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Programación\Desktop\QUEATER\resources\views/dashboard-views/dashboard-products.blade.php ENDPATH**/ ?>