<?php $__env->startSection('dashboard-content'); ?>
    ...
    <main class="w-full h-[calc(100vh-3.5rem)] flex flex-col gap-4 overflow-y-scroll">
        ...
        <section class="flex flex-col gap-4">
            ...
            <div id="qrs-container" class="flex flex-wrap gap-4 p-8 w-fit h-fit bg-slate-500 rounded-lg shadow-4">
                <?php if(file_exists(storage_path('app/public/qrcodes_images/take_away.svg'))): ?>
...
<?php echo $__env->make('dashboard-views.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u272775609/domains/queater.com/resources/views/dashboard-views/dashboard-tables.blade.php ENDPATH**/ ?>