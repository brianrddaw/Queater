...
@section('content')
    ...
    <main class="w-full h-full min-h-[calc(100vh-3.5rem)] p-6 px-14 flex flex-col gap-4">
        <h1 class="text-4xl font-bold p-4 rounded w-fit bg-stone-200">Pedidos listos para recoger</h1>
            ...
            <div class="all-orders-container flex w-full rounded gap-6">
                <ul id="orders-ctn" class="flex flex-col gap-4 select-none text-orange-950 rounded w-full h-[75vh] p-4 bg-cyan-100 shadow-stone-300 shadow-4">
                    <div class="flex justify-between text-2xl w-full h-fit items-center gap-6">
                        ...
                        <div class="flex items-center font-bold bg-yellow-950 text-orange-50 gap-4 p-4 rounded">
                            <h3 id="total-eat-here">Total: {{ count($eatHereOrders) }}</h3>
                    ...
                    <div id="eat-here-orders-ctn" class="overflow-y-auto">
                        {{-- Eat Here Orders --}}
                    </div>
                </ul>
                ...
                <ul class="flex flex-col gap-4 select-none text-orange-950 w-full h-[75vh] rounded p-4 bg-orange-100 shadow-stone-300 shadow-4">
                    <div class="flex justify-between text-2xl w-full h-fit items-center gap-6">
                        ...
                        <div class="flex items-center font-bold bg-yellow-950 text-orange-50 gap-4 p-4 rounded">
                            <h3 id="total-take-away">Total: {{ count($takeAwayOrders) }}</h3>
                    ...
                    <div id="take-away-orders-ctn" class="overflow-y-auto">
                    {{-- Take Away Orders --}}
                    </div>
                </ul>
