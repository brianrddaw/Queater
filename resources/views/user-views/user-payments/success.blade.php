...
@section('content')
    <section class="flex flex-col items-center gap-6 mt-6 text-orange-950">
        ...
        <span class="flex flex-col w-fit h-full items-center gap-4 mt-6">
            <a class="min-w-fit w-44 h-14 text-center  flex items-center justify-center  bg-orange-500 rounded font-bold text-orange-50" href="/printTicket/{{ $orderId }}">Imprimir ticket</a>
