...
<section class="flex flex-col gap-10 w-[100vw] h-[calc(100vh-3.5rem)] p-20 text-orange-800 bg-orange-200">
    ...
    <img class="absolute bottom-0 right-0 w-[1000px] md:w-[20rem] xs:hidden md:block xl:w-[50rem] z-0" src="{{ asset('imgs/chef-landpage.svg ') }}" alt="">
</section>
<!-- <section class="flex flex-col w-full h-[calc(100vh-3.5rem)] items-center pt-8 gap-4 text-orange-800 lg:max-w-[80vw] lg:max-h-[80vh] lg:m-auto lg:flex-col">
    ...
    <div class=" flex">
        <img class="absolute bottom-0 right-0 w-[1000px] md:w-[500px] xs:hidden sm:block lg:w-[900px] z-0" src="{{ asset('imgs/chef-landpage.svg ') }}" alt="">
